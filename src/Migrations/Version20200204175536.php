 ...
 */
final class Version20200204175536 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE compte ADD partenaire_id INT NOT NULL, ADD user_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE compte DROP partenaire_id, DROP user_id');
